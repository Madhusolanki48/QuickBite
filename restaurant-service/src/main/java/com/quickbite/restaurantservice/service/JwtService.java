...
import com.quickbite.restaurantservice.config.JwtProperties;
...
public class JwtService {
    ...
    /**
     * Extracts the 'role' claim from the JWT (e.g. "ADMIN", "RESTAURANT_OWNER", "CUSTOMER").
     * Returns "CUSTOMER" as a safe default if the claim is absent.
     */
