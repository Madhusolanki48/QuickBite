package com.quickbite.deliveryservice.security;
...
public class InternalAuthFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !path.startsWith("/api/delivery-agents/internal") &&
               !path.startsWith("/delivery-agents/internal") &&
               !path.startsWith("/api/deliveries/internal") &&
               !path.startsWith("/deliveries/internal");
    }
